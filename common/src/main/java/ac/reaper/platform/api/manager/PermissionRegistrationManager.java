...
public interface PermissionRegistrationManager {
     ...
     * dynamic permissions (e.g., check-specific permissions like "reaper.exempt.checkname")
     * are available for autocomplete before Reaper attempts to use them. This is
     ...
     *
     * @param name         The permission node to register (e.g., "reaper.exempt").
