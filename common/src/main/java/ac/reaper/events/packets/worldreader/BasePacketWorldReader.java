package ac.reaper.events.packets.worldreader;
...
public class BasePacketWorldReader extends PacketListenerAbstract {
    ...
    public void handleMapChunkBulk(ReaperPlayer player, PacketSendEvent event) {
    ...
    public void handleMapChunk(ReaperPlayer player, PacketSendEvent event) {
    ...
    public void addChunkToCache(PacketSendEvent event, ReaperPlayer player, BaseChunk[] chunks, boolean isGroundUp, int chunkX, int chunkZ) {
    ...
    public void unloadChunk(ReaperPlayer player, int x, int z) {
        if (player == null) return;
        player.compensatedWorld.removeChunkLater(x, z);
    }

    public void handleBlockChange(ReaperPlayer player, PacketSendEvent event) {
    ...
    public void handleMultiBlockChange(ReaperPlayer player, PacketSendEvent event) {
