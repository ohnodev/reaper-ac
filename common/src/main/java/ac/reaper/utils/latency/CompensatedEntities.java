...
import ac.reaper.utils.data.packetentity.dragon.PacketEntityEnderDragon;
import ac.reaper.utils.nmsutil.BoundingBoxSize;
import ac.reaper.utils.nmsutil.WatchableIndexUtil;
...
public class CompensatedEntities {
    ...
    public CompensatedEntities(ReaperPlayer player) {
        this.player = player;
