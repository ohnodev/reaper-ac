package ac.reaper.internal.plugin.resolver;
 ...
 */
@ApiStatus.Internal
public final class ReaperExtensionManager {
    private final List<ReaperExtensionResolver> resolvers = new CopyOnWriteArrayList<>();
     ...
     */
    public void registerResolver(@NotNull ReaperExtensionResolver resolver) {
    ...
    public ReaperPlugin getPlugin(@NotNull Object context) {
        ...
        for (ReaperExtensionResolver resolver : resolvers) {
