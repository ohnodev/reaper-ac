package ac.reaper.platform.fabric.utils.convert;
...
//            DynamicRegistryManager registryManager = ReaperACFabricLoaderPlugin.FABRIC_SERVER.getRegistryManager(); // Replace with actual method to get registry manager
//
