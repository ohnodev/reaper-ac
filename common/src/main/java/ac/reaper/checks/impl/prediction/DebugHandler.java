...
import ac.reaper.checks.debug.AbstractDebugHandler;
...
public class DebugHandler extends AbstractDebugHandler implements PostPredictionCheck {
    ...
    private final Set<ReaperPlayer> listeners = new CopyOnWriteArraySet<>(new HashSet<>());
    ...
    public DebugHandler(ReaperPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        for (ReaperPlayer listener : listeners) {
        ...
        if (outputToConsole) {
            Sender consoleSender = ReaperAPI.INSTANCE.getPlatformServer().getConsoleSender();
    ...
    @Override
    public void toggleListener(ReaperPlayer player) {
