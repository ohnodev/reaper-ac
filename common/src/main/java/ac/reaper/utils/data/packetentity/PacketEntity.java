// This file was designed and is an original check for ReaperAC
...
import ac.reaper.utils.data.ReachInterpolationData;
import ac.reaper.utils.data.TrackedPosition;
...
public class PacketEntity extends TypedPacketEntity {
    ...
    public PacketEntity(ReaperPlayer player, EntityType type) {
        super(type);
        this.uuid = null;
    ...
    public PacketEntity(ReaperPlayer player, UUID uuid, EntityType type, double x, double y, double z) {
        super(type);
        this.uuid = uuid;
        initAttributes(player);
        this.trackedServerPosition = new TrackedPosition();
    ...
    protected void initAttributes(ReaperPlayer player) {
    ...
    public void onFirstTransaction(boolean relative, boolean hasPos, double relX, double relY, double relZ, ReaperPlayer player) {
        if (hasPos) {
            if (relative) {
    ...
    public void setPositionRaw(ReaperPlayer player, SimpleCollisionBox box) {
