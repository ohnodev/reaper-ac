...
import ac.reaper.utils.data.BlockPrediction;
import ac.reaper.utils.data.Pair;
import ac.reaper.utils.data.PistonData;
import ac.reaper.utils.data.ShulkerData;
import ac.reaper.utils.data.packetentity.PacketEntity;
import ac.reaper.utils.data.packetentity.PacketEntityShulker;
...
public class CompensatedWorld implements PacketWorld {
    ...
    public CompensatedWorld(ReaperPlayer player) {
        this.player = player;
    ...
    public double getWaterFluidLevelAt(double x, double y, double z) {
        return getWaterFluidLevelAt(ReaperMath.floor(x), ReaperMath.floor(y), ReaperMath.floor(z));
    }
