...
import ac.reaper.events.packets.PacketWorldBorder;
import ac.reaper.player.ReaperPlayer;
import ac.reaper.predictionengine.blockeffects.BlockEffectsResolver;
import ac.reaper.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_10;
import ac.reaper.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_2;
import ac.reaper.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_4;
import ac.reaper.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_5;
import ac.reaper.predictionengine.blockeffects.impl.BlockEffectsResolverV1_21_6;
import ac.reaper.utils.chunks.Column;
...
public final class Collisions {
    ...
    public static boolean slowCouldPointThreeHitGround(ReaperPlayer player, double x, double y, double z) {
    ...
    public static Vector3dm collide(ReaperPlayer player, double desiredX, double desiredY, double desiredZ) {
        return collide(player, desiredX, desiredY, desiredZ, desiredY, null);
    }

    public static Vector3dm collide(ReaperPlayer player, double desiredX, double desiredY, double desiredZ, double clientVelY, VectorData data) {
    ...
    public static boolean addWorldBorder(ReaperPlayer player, SimpleCollisionBox wantedBB, List<SimpleCollisionBox> listOfBlocks, boolean onlyCheckCollide) {
    ...
    public static boolean getCollisionBoxes(ReaperPlayer player, SimpleCollisionBox wantedBB, List<SimpleCollisionBox> listOfBlocks, boolean onlyCheckCollide) {
    ...
    public static boolean isEmpty(ReaperPlayer player, SimpleCollisionBox playerBB) {
    ...
    public static Vector3dm maybeBackOffFromEdge(Vector3dm vec3, ReaperPlayer player, boolean overrideVersion) {
    ...
    public static boolean isAboveGround(ReaperPlayer player) {
    ...
    public static void handleInsideBlocks(ReaperPlayer player) {
    ...
    public static void onInsideBlock(ReaperPlayer player, StateType blockType, WrappedBlockState block, int blockX, int blockY, int blockZ, boolean magic) {
    ...
    public static void applyEffectsFromBlocks(ReaperPlayer player) {
        ...
        if (clientVersion.isOlderThan(ClientVersion.V_1_21_5)) {
            player.finalMovementsThisTick.add(new ReaperPlayer.Movement(from, to));
            ...
            if (player.finalMovementsThisTick.isEmpty()) {
                ...
                player.finalMovementsThisTick.add(new ReaperPlayer.Movement(player.finalMovementsThisTick.get(player.finalMovementsThisTick.size() - 1).to(), to));
            }
        }
    ...
    public static void resolveBlockEffects(ReaperPlayer player, Vector3d from, Vector3d to) {
        Collisions.resolveBlockEffects(player, List.of(new ReaperPlayer.Movement(from, to)));
    }

    public static void resolveBlockEffects(ReaperPlayer player, List<ReaperPlayer.Movement> movements) {
    ...
    private static double getOldDeltaY(ReaperPlayer player, double value) {
        return player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_21_2) ? value / 0.98F + 0.08 : value;
    }

    private static double getNewDeltaY(ReaperPlayer player, double value) {
        return player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_21_2) ? (value - 0.08) * 0.98F : value;
    }

    private static boolean isSlidingDown(Vector3dm vector, ReaperPlayer player, int locationX, int locationY,
                                         int locationZ) {
        if (player.onGround) {
            return false;
    ...
    // 0.03 hack
    public static boolean checkStuckSpeed(ReaperPlayer player, double expand) {
        // Use the bounding box for after the player's movement is applied
    ...
    public static boolean suffocatesAt(ReaperPlayer player, SimpleCollisionBox playerBB) {
    ...
    public static boolean doesBlockSuffocate(ReaperPlayer player, int x, int y, int z) {
        WrappedBlockState data = player.compensatedWorld.getBlock(x, y, z);
    ...
    // Thanks Tuinity
    public static boolean hasMaterial(ReaperPlayer player, SimpleCollisionBox checkBox, Predicate<Pair<WrappedBlockState, Vector3i>> searchingFor) {
    ...
    // Thanks Tuinity
    public static void forEachCollisionBox(@NotNull ReaperPlayer player, @NotNull SimpleCollisionBox checkBox, @NotNull Consumer<@NotNull Vector3d> searchingFor) {
    ...
    public static boolean onClimbable(ReaperPlayer player, double x, double y, double z) {
    ...
    public static boolean trapdoorUsableAsLadder(ReaperPlayer player, double x, double y, double z, WrappedBlockState blockData) {
