package ac.reaper.manager.player.handlers;
...
public record DefaultResyncHandler(ReaperPlayer player) implements ResyncHandler {

    private static void resyncPositions(ReaperPlayer player, int minBlockX, int mY, int minBlockZ, int maxBlockX, int mxY, int maxBlockZ) {
        ...
        ReaperAPI.INSTANCE.getScheduler().getRegionScheduler().execute(ReaperAPI.INSTANCE.getReaperPlugin(), world,
    ...
    private static void resyncPosition(ReaperPlayer player, int x, int y, int z, int sequence) {
        if (player.platformPlayer == null) return;
        ...
        ReaperAPI.INSTANCE.getScheduler().getRegionScheduler().execute(ReaperAPI.INSTANCE.getReaperPlugin(), world, chunkX, chunkZ, () -> {
