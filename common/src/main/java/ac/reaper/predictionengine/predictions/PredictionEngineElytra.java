...
public class PredictionEngineElytra extends PredictionEngine {
    public static Vector3dm getElytraMovement(ReaperPlayer player, Vector3dm vector, Vector3dm lookVector) {
        float pitchRadians = ReaperMath.radians(player.pitch);
        ...
        // Yeah, slow falling needs a refactor in reaper.
