...
import ac.reaper.api.event.events.CompletePredictionEvent;
...
public class OffsetHandler extends Check implements PostPredictionCheck {
    ...
    public OffsetHandler(ReaperPlayer player) {
        super(player);
    }
    ...
    public void onPredictionComplete(final PredictionComplete predictionComplete) {
        ...
        ReaperAPI.INSTANCE.getEventBus().post(completePredictionEvent);
