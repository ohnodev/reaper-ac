package ac.reaper.utils.collisions;

import ac.reaper.player.ReaperPlayer;
import ac.reaper.predictionengine.movementtick.MovementTickerStrider;
import ac.reaper.utils.collisions.blocks.DoorHandler;
import ac.reaper.utils.collisions.blocks.DynamicChest;
import ac.reaper.utils.collisions.blocks.DynamicChorusPlant;
import ac.reaper.utils.collisions.blocks.DynamicStair;
import ac.reaper.utils.collisions.blocks.PistonBaseCollision;
import ac.reaper.utils.collisions.blocks.PistonHeadCollision;
import ac.reaper.utils.collisions.blocks.TrapDoorHandler;
import ac.reaper.utils.collisions.blocks.connecting.DynamicCollisionFence;
import ac.reaper.utils.collisions.blocks.connecting.DynamicCollisionPane;
import ac.reaper.utils.collisions.blocks.connecting.DynamicCollisionWall;
import ac.reaper.utils.collisions.datatypes.CollisionBox;
import ac.reaper.utils.collisions.datatypes.CollisionFactory;
import ac.reaper.utils.collisions.datatypes.ComplexCollisionBox;
import ac.reaper.utils.collisions.datatypes.DynamicCollisionBox;
import ac.reaper.utils.collisions.datatypes.HexCollisionBox;
import ac.reaper.utils.collisions.datatypes.HexOffsetCollisionBox;
import ac.reaper.utils.collisions.datatypes.NoCollisionBox;
...
public enum CollisionData implements CollisionFactory {
    ...
    public CollisionBox getMovementCollisionBox(ReaperPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
        return fetch(player, version, block, x, y, z).offset(x, y, z);
    }

    public CollisionBox getMovementCollisionBox(ReaperPlayer player, ClientVersion version, WrappedBlockState block) {
        if (this.box != null)
    ...
    @Override
    public CollisionBox fetch(ReaperPlayer player, ClientVersion version, WrappedBlockState block, int x, int y, int z) {
