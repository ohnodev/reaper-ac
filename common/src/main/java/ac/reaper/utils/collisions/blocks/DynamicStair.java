package ac.reaper.utils.collisions.blocks;
...
public class DynamicStair implements CollisionFactory {
    ...
    public static EnumShape getStairsShape(ReaperPlayer player, WrappedBlockState originalStairs, int x, int y, int z) {
    ...
    private static boolean canTakeShape(ReaperPlayer player, WrappedBlockState stairOne, int x, int y, int z) {
