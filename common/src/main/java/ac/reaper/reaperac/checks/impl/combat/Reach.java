...
import ac.reaper.reaperac.utils.data.packetentity.PacketEntitySizeable;
...
public class Reach extends Check implements PacketCheck {
    ...
    private void onInteract(PacketReceiveEvent event, int entityId, InteractionHand hand) {
        ...
        if (entity.type == EntityTypes.HAPPY_GHAST) {
            player.getClientVersion();
        }
        ...
        boolean clientAndServerAgrees = ATTACK_RANGE_COMPONENT_EXISTS;
