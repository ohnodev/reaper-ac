...
import ac.reaper.checks.impl.badpackets.BadPacketsE;
import ac.reaper.checks.impl.badpackets.BadPacketsF;
import ac.reaper.checks.impl.badpackets.BadPacketsG;
import ac.reaper.checks.impl.badpackets.BadPacketsH;
import ac.reaper.checks.impl.elytra.ElytraC;
...
public class PacketPlayerRespawn extends PacketListenerAbstract {
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.RESPAWN) {
            ...
            player.latencyUtils.addRealTimeTask(player.lastTransactionSent.get() + 1, () -> {
                ...
                if (!ReaperAPI.INSTANCE.getSpectateManager().isSpectating(player.uuid)) {
    ...
    private boolean isWorldChange(ReaperPlayer player, WrapperPlayServerRespawn respawn) {
