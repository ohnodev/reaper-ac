...
public class PacketWorldReaderEight extends BasePacketWorldReader {
    @Override
    public void handleMapChunkBulk(final ReaperPlayer player, final PacketSendEvent event) {
    ...
    @Override
    public void handleMapChunk(final ReaperPlayer player, final PacketSendEvent event) {
        PacketWrapper<?> wrapper = new PacketWrapper<>(event);
