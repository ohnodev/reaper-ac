// This file was designed and is an original check for ReaperACBukkitLoaderPlugin
...
public class ReachInterpolationData {
    ...
    public ReachInterpolationData(ReaperPlayer player, SimpleCollisionBox startingLocation, TrackedPosition position, PacketEntity entity) {
    ...
    public ReachInterpolationData(ReaperPlayer player, SimpleCollisionBox finishedLoc, PacketEntity entity) {
...
//        int interpolationStepsLowBound = Math.min(this.interpolationStepsLowBound, this.cancelledLerpInterpolationStepsLowBound); // Temp test
    ...
    public void updatePossibleStartingLocation(SimpleCollisionBox possibleLocationCombined) {
        //ReaperACBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Updated new starting location as second trans hasn't arrived " + startingLocation);
        this.startingLocation = combineCollisionBox(startingLocation, possibleLocationCombined);
        //ReaperACBukkitLoaderPlugin.staticGetLogger().info(ChatColor.BLUE + "Finished updating new starting location as second trans hasn't arrived " + startingLocation);
    }
