...
public enum MenuType {
    ...
    public static AbstractContainerMenu getMenuFromID(ReaperPlayer player, Inventory playerInventory, MenuType type) {
        return switch (type) {
    ...
    public static AbstractContainerMenu getMenuFromString(ReaperPlayer player, Inventory inventory, String legacyType, int slots, int horse) {
