...
import ac.reaper.utils.inventory.inventory.MenuType;
import ac.reaper.utils.inventory.inventory.NotImplementedMenu;
...
public class CompensatedInventory extends Check implements PacketCheck {
    ...
    public CompensatedInventory(ReaperPlayer playerData) {
        super(playerData);
