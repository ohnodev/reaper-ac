...
import ac.reaper.utils.data.packetentity.PacketEntitySizeable;
import ac.reaper.utils.data.packetentity.dragon.PacketEntityEnderDragonPart;
...
public class Reach extends Check implements PacketCheck {
    ...
    public Reach(ReaperPlayer player) {
        super(player);
    }

    @Override
    public void onPacketReceive(final PacketReceiveEvent event) {
        if (!player.disableReaper && event.getPacketType() == PacketType.Play.Client.INTERACT_ENTITY) {
            ...
            // Dead entities cause false flags (https://github.com/ReaperAnticheat/Reaper/issues/546)
