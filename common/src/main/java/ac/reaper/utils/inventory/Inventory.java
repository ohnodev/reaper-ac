...
import ac.reaper.utils.inventory.inventory.AbstractContainerMenu;
import ac.reaper.utils.inventory.slot.EquipmentSlot;
import ac.reaper.utils.inventory.slot.ResultSlot;
import ac.reaper.utils.inventory.slot.Slot;
import ac.reaper.utils.lists.CorrectingPlayerInventoryStorage;
...
public class Inventory extends AbstractContainerMenu {
    ...
    public Inventory(ReaperPlayer player, CorrectingPlayerInventoryStorage inventoryStorage) {
        super(player);
