...
public class PacketEntityHorse extends PacketEntityTrackXRot implements JumpableEntity {
    ...
    public PacketEntityHorse(ReaperPlayer player, UUID uuid, EntityType type, double x, double y, double z, float xRot) {
    ...
    @Override
    public boolean canPlayerJump(ReaperPlayer player) {
        return this.hasSaddle();
    }

    @Override
    public void executeJump(ReaperPlayer player, Set<VectorData> possibleVectors) {
        ...
        float yawRadians = ReaperMath.radians(player.yaw);
