...
public class LogUtil {
    ...
    public Logger getLogger() {
        return ReaperAPI.INSTANCE.getReaperPlugin().getLogger();
    }

    public void console(final String info) {
        ReaperAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(MessageUtil.translateAlternateColorCodes('&', info));
    }

    public void console(final Component info) {
        ReaperAPI.INSTANCE.getPlatformServer().getConsoleSender().sendMessage(info);
    }
