...
import ac.reaper.utils.worldborder.BorderExtent;
import ac.reaper.utils.worldborder.RealTimeMovingBorderExtent;
import ac.reaper.utils.worldborder.StaticBorderExtent;
import ac.reaper.utils.worldborder.TickBasedMovingBorderExtent;
...
public class PacketWorldBorder extends Check implements PacketCheck {
    ...
    public PacketWorldBorder(ReaperPlayer playerData) {
        super(playerData);
