...
import ac.reaper.checks.impl.aim.AimDuplicateLook;
import ac.reaper.checks.impl.aim.AimModulo360;
import ac.reaper.checks.impl.aim.processor.AimProcessor;
import ac.reaper.checks.impl.badpackets.*;
import ac.reaper.checks.impl.breaking.*;
import ac.reaper.checks.impl.chat.ChatA;
import ac.reaper.checks.impl.chat.ChatB;
import ac.reaper.checks.impl.chat.ChatC;
import ac.reaper.checks.impl.chat.ChatD;
import ac.reaper.checks.impl.combat.*;
import ac.reaper.checks.impl.crash.*;
import ac.reaper.checks.impl.elytra.*;
import ac.reaper.checks.impl.exploit.ExploitA;
import ac.reaper.checks.impl.exploit.ExploitB;
import ac.reaper.checks.impl.groundspoof.NoFall;
import ac.reaper.checks.impl.misc.ClientBrand;
import ac.reaper.checks.impl.misc.GhostBlockMitigation;
import ac.reaper.checks.impl.misc.Post;
import ac.reaper.checks.impl.misc.TransactionOrder;
import ac.reaper.checks.impl.movement.NoSlow;
import ac.reaper.checks.impl.movement.PredictionRunner;
import ac.reaper.checks.impl.movement.SetbackBlocker;
import ac.reaper.checks.impl.movement.VehiclePredictionRunner;
import ac.reaper.checks.impl.multiactions.*;
import ac.reaper.checks.impl.packetorder.*;
import ac.reaper.checks.impl.prediction.DebugHandler;
import ac.reaper.checks.impl.prediction.GroundSpoof;
import ac.reaper.checks.impl.prediction.OffsetHandler;
import ac.reaper.checks.impl.prediction.Phase;
import ac.reaper.checks.impl.scaffolding.*;
import ac.reaper.checks.impl.sprint.*;
import ac.reaper.checks.impl.timer.*;
import ac.reaper.checks.impl.vehicle.*;
import ac.reaper.checks.impl.velocity.ExplosionHandler;
import ac.reaper.checks.impl.velocity.KnockbackHandler;
import ac.reaper.checks.type.*;
import ac.reaper.events.packets.PacketChangeGameState;
import ac.reaper.events.packets.PacketEntityReplication;
import ac.reaper.events.packets.PacketPlayerAbilities;
...
import ac.reaper.predictionengine.GhostBlockDetector;
import ac.reaper.predictionengine.SneakingEstimator;
import ac.reaper.utils.anticheat.update.*;
import ac.reaper.utils.latency.CompensatedCameraEntity;
import ac.reaper.utils.latency.CompensatedCooldown;
import ac.reaper.utils.latency.CompensatedFireworks;
import ac.reaper.utils.latency.CompensatedInventory;
import ac.reaper.utils.team.TeamHandler;
...
public class CheckManager {
    ...
    public CheckManager(ReaperPlayer player) {
    ...
    private void init() {
        ...
        for (final AbstractCheck check : allChecks.values()) {
            ...
            for (String permissionName : permissions) {
                permissionName += id;
                ReaperAPI.INSTANCE.getPermissionManager().registerPermission(permissionName, PermissionDefaultValue.FALSE);
            }
        }
    }
}
