...
public interface ReaperAbstractAPI extends ConfigReloadable, BasicReloadable {
    /**
     * Returns EventBus instanced used to register events and listen to Reaper events
    ...
    /**
     * Retrieves the plugin version of Reaper.
     * @return Reaper version
     */
    ...
    /**
     * Reloads Reaper using the config file.
     */
    @Override
    default void reload() {
    ...
    /**
     * Reloads Reaper asynchronously using the config file.
