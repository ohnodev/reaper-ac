...
import ac.reaper.utils.collisions.AxisUtil;
...
public class ConsumesBlockPlace {
    public static boolean consumesPlace(@NotNull ReaperPlayer player, @NotNull WrappedBlockState state, @NotNull BlockPlace place) {
