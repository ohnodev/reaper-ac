package ac.reaper.utils.data.webhook.discord;

import ac.reaper.utils.data.json.JsonSerializable;
...
import static ac.reaper.utils.data.json.JsonSerializable.deserializeArray;
import static ac.reaper.utils.data.json.JsonSerializable.serializeArray;
