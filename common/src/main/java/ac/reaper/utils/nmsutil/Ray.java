...
public class Ray implements Cloneable {
    ...
    public Ray(ReaperPlayer player, double x, double y, double z, float xRot, float yRot) {
    ...
    public static Vector3dm calculateDirection(ReaperPlayer player, float xRot, float yRot) {
