...
echo "[all] Case 1/1: Reaper + PE official (26.1)"
...
"${SCRIPT_DIR}/bootstrap-reaper-pe-official-261.sh"
smoke_start "reaper-pe-official-261" "${SCRIPT_DIR}/run-server.sh" --server-dir tests/runs/reaper-pe-26.1 --java-bin "${JAVA25_BIN}"

echo "[all] Reaper + PacketEvents harness complete."
