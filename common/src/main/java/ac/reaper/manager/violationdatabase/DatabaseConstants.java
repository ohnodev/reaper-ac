...
public interface DatabaseConstants {
    String SERVERS_TABLE = "reaper_history_servers";
    String CHECK_NAMES_TABLE = "reaper_history_check_names";
    String REAPER_VERSIONS_TABLE = "reaper_history_versions";
    String CLIENT_BRANDS_TABLE = "reaper_history_client_brands";
    String CLIENT_VERSIONS_TABLE = "reaper_history_client_versions";
    String SERVER_VERSIONS_TABLE = "reaper_history_server_versions";
    String VIOLATIONS_TABLE = "reaper_history_violations";

    String SERVERS_STRING_COLUMN = "server_name";
    String CHECK_NAMES_STRING_COLUMN = "check_name_string";
    String REAPER_VERSIONS_STRING_COLUMN = "reaper_version_string";
    ...
    String VIOLATIONS_REAPER_VERSION_ID_COLUMN = "reaper_version_id";
