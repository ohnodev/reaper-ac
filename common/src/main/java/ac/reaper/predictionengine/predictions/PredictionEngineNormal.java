...
public class PredictionEngineNormal extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(ReaperPlayer player, Vector3dm vector) {
    ...
    public Vector3dm handleOnClimbable(Vector3dm vector, ReaperPlayer player) {
        if (player.isClimbing) {
            ...
            vector.setX(ReaperMath.clamp(vector.getX(), -0.15F, 0.15F));
            vector.setZ(ReaperMath.clamp(vector.getZ(), -0.15F, 0.15F));
