...
"${SCRIPT_DIR}/bootstrap-reaper-pe-bukkit-paper-1206.sh"
smoke_start "reaper-pe-paper-1206" "${SCRIPT_DIR}/run-bukkit-server.sh" --server-dir tests/runs/reaper-pe-paper-1.20.6

echo "[all-bukkit] Case 2/2: Spigot path (1.21.1)"
"${SCRIPT_DIR}/bootstrap-reaper-pe-bukkit-spigot-1211.sh"
smoke_start "reaper-pe-spigot-1211" "${SCRIPT_DIR}/run-bukkit-server.sh" --server-dir tests/runs/reaper-pe-spigot-1.21.1

echo "[all-bukkit] Reaper + PacketEvents Bukkit harness complete."
