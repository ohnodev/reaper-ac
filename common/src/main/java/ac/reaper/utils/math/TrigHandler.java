...
public class TrigHandler {
    ...
    public TrigHandler(ReaperPlayer player) {
        this.player = player;
    }
    ...
    public Vector3dm getVanillaMathMovement(Vector3dm wantedMovement, float f, float f2) {
        float f3 = VanillaMath.sin(ReaperMath.radians(f2));
        float f4 = VanillaMath.cos(ReaperMath.radians(f2));
    ...
    public Vector3dm getShitMathMovement(Vector3dm wantedMovement, float f, float f2) {
        float f3 = player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_8) ? OptifineFastMath.sin(ReaperMath.radians(f2)) : LegacyFastMath.sin(ReaperMath.radians(f2));
        float f4 = player.getClientVersion().isNewerThanOrEquals(ClientVersion.V_1_8) ? OptifineFastMath.cos(ReaperMath.radians(f2)) : LegacyFastMath.cos(ReaperMath.radians(f2));
