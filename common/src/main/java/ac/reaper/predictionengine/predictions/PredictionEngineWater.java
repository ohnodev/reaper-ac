...
public class PredictionEngineWater extends PredictionEngine {
    ...
    public static void staticVectorEndOfTick(ReaperPlayer player, Vector3dm vector, float swimmingFriction, double playerGravity, boolean isFalling) {
    ...
    public static Set<VectorData> transformSwimmingVectors(ReaperPlayer player, Set<VectorData> base) {
    ...
    public void guessBestMovement(float swimmingSpeed, ReaperPlayer player, boolean isFalling, double playerGravity, float swimmingFriction) {
    ...
    @Override
    public void endOfTick(ReaperPlayer player, double playerGravity) {
