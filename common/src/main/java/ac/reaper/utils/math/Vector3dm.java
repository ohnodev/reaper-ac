...
public class Vector3dm implements Cloneable, Serializable {
    ...
    public double length() {
        return Math.sqrt(ReaperMath.square(this.x) + ReaperMath.square(this.y) + ReaperMath.square(this.z));
    }

    public double lengthSquared() {
        return ReaperMath.square(this.x) + ReaperMath.square(this.y) + ReaperMath.square(this.z);
    }
    ...
    public double distanceSquared(double oX, double oY, double oZ) {
        return ReaperMath.square(this.x - oX) + ReaperMath.square(this.y - oY) + ReaperMath.square(this.z - oZ);
    }
    ...
    public boolean isInSphere(@NotNull Vector3dm origin, double radius) {
        return ReaperMath.square(origin.x - this.x) + ReaperMath.square(origin.y - this.y) + ReaperMath.square(origin.z - this.z) <= ReaperMath.square(radius);
    }
    ...
    public int getBlockX() {
        return ReaperMath.mojangFloor(this.x);
    }
    ...
    public int getBlockY() {
        return ReaperMath.mojangFloor(this.y);
    }
    ...
    public int getBlockZ() {
        return ReaperMath.mojangFloor(this.z);
    }
