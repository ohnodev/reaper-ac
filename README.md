...
- `prebuilt/reaperac-fabric-2.3.74-fix_reaperac-fabric-plugin-context-7434f29.jar`
- `prebuilt/reaperac-fabric-2.3.74-fix_reaperac-fabric-plugin-context-7434f29.jar.sha256`

Verify integrity:

```bash
sha256sum -c prebuilt/reaperac-fabric-2.3.74-fix_reaperac-fabric-plugin-context-7434f29.jar.sha256
```
