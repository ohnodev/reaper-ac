...
public class BlockTags {
    ...
    static {
        ...
        // 26.2: sulfur/cinnabar families must participate in mining speed and harvest checks (mineable/pickaxe matches vanilla jar).
        // needs_stone_tool: vanilla 26.2 does not list these blocks — do not add here or Grim/Reaper tier inference diverges from the game.
        BlockTags.MINEABLE_PICKAXE.add(
                StateTypes.SULFUR, StateTypes.POTENT_SULFUR, StateTypes.SULFUR_SLAB, StateTypes.SULFUR_STAIRS, StateTypes.SULFUR_WALL,
                StateTypes.POLISHED_SULFUR, StateTypes.POLISHED_SULFUR_SLAB, StateTypes.POLISHED_SULFUR_STAIRS, StateTypes.POLISHED_SULFUR_WALL,
                StateTypes.SULFUR_BRICKS, StateTypes.SULFUR_BRICK_SLAB, StateTypes.SULFUR_BRICK_STAIRS, StateTypes.SULFUR_BRICK_WALL, StateTypes.CHISELED_SULFUR,
                StateTypes.CINNABAR, StateTypes.CINNABAR_SLAB, StateTypes.CINNABAR_STAIRS, StateTypes.CINNABAR_WALL,
                StateTypes.POLISHED_CINNABAR, StateTypes.POLISHED_CINNABAR_SLAB, StateTypes.POLISHED_CINNABAR_STAIRS, StateTypes.POLISHED_CINNABAR_WALL,
                StateTypes.CINNABAR_BRICKS, StateTypes.CINNABAR_BRICK_SLAB, StateTypes.CINNABAR_BRICK_STAIRS, StateTypes.CINNABAR_BRICK_WALL, StateTypes.CHISELED_CINNABAR
        );
    }
